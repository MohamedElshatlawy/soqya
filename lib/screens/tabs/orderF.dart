...
class OrderF extends StatefulWidget {
  @override
  _OrderFState createState() => _OrderFState();
}

class _OrderFState extends State<OrderF> {
  bool _Loading = true;
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: InkWell(
            onTap: () {
              debugPrint('${userOrders[index].order_id}');
              Navigator.push(
                context,
                MaterialPageRoute(
